...
public class AlarmeListaCuidador extends AppCompatActivity {
    ...
    class SwipeCallback extends ItemTouchHelper.SimpleCallback {
        ...
        private void init() {
            background = new ColorDrawable(Color.RED);
            xMark = ContextCompat.getDrawable(AlarmeListaCuidador.this, R.drawable.ic_clear_24px);
            xMark.setColorFilter(Color.WHITE, PorterDuff.Mode.SRC_ATOP);
            xMarkMargin = (int) AlarmeListaCuidador.this.getResources().getDimension(R.dimen.ic_clear_margin);
            initiated = true;
        }
    ...
    class SwipeCallbackRight extends ItemTouchHelper.SimpleCallback{
        ...
        private void init() {
            background = new ColorDrawable(Color.RED);
            xMark = ContextCompat.getDrawable(AlarmeListaCuidador.this, R.drawable.ic_menu_manage);
        ...
        public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
            ...
            finish();
            Intent intent = new Intent(AlarmeListaCuidador.this, AlarmeAtualizacaoActivity.class);
